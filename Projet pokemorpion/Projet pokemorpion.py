...
class Pokemorpion():
    def __init__(self):
        self.pk = pds.read_csv(r"pokemon_modified.csv", index_col="Name")
    ...
    def random_draft(self):
        ...
        self.player_1 = pds.concat([pl1_pool_1,pl1_pool_2,pl1_pool_3,pl1_pool_4])
        self.player_2 = pds.concat([pl2_pool_1,pl2_pool_2,pl2_pool_3,pl2_pool_4])
